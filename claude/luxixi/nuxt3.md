...
适用范围：Nuxt 3 项目（管理系统、官网、H5、落地页等）。后端接口、数据库、缓存、Nginx 等规则分别由对应项目或技术栈规则声明。
...
- 需要 SSR 首屏数据时，必须使用 Nuxt 数据获取机制（`useFetch` / `useAsyncData`），并处理 pending / error / empty 状态
...
- Nuxt 3 文档 context7 library ID：`/websites/nuxt_3_x`
